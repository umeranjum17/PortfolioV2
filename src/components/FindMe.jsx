    ...
    return (
        <div className="flex-1">
            ...
            <ul className="flex items-center justify-center text-2xl text-white">
                <li><a href="" className="social-icon"> <i className="fa text-white mx-2 bg-blue-800 fa-linkedin"></i></a></li>
                <li><a href="" className="social-icon"> <i className="fa text-white mx-2  bg-gray-800 fa-github"></i></a></li>
            </ul>
